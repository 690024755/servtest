...
import com.galaxyeye.websocket.test.galaxyeye.MpService.BO.GetBriefBO;
...
@Slf4j
@Component
public class GetBriefTest extends BaseTest {

    @Autowired
    private ManualConfigRepository manualConfigRepository;

    /**
     *请求参数uid与token不传,获取通用配置其他信息
     * @throws Exception
     */
    @Test
    public void getbriefTestByNotUidAndToken() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            getBriefUrl = url+"/BusinessService/config/getbrief";
            getBriefBO = new GetBriefBO();
            getBriefBO.setBmAppid("4.00090");
            //参数appid=manual_config.appid，用于查询不同小程序的配置信息
            getBriefBO.setAppid("4.00090");
            //参数Env=manual_config.conf_env
            getBriefBO.setEnv("dev");
            //参数Key=manual_config.conf_key
            List<String> list=new ArrayList<>();
            list.add("healthPlanAbs");
            getBriefBO.setKeys(list);
            getBriefBO.setVersion("5.0.0");
            log.info("getBriefUrl 请求的参数=" + getBriefUrl);
            log.info("getBriefBO 请求的参数=" + JSON.toJSONString(getBriefBO));
            getbriefResult = HttpUtil.postGeneralUrl(getBriefUrl, "application/json", JSON.toJSONString(getBriefBO), "UTF-8");
            log.info("getbriefResult 返回结果=" + JSON.parseObject(getbriefResult));
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("请求参数uid与token不传,获取通用配置其他信息");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
            Assert.assertEquals(getbriefResult.contains("\"result\":1"),true);
            Assert.assertEquals(getbriefResult.contains("\"msg\":\"ok\""),true);
            Assert.assertEquals(getbriefResult.contains("configs"),true);
            Assert.assertEquals(getbriefResult.contains("verify"),true);
            Assert.assertEquals(getbriefResult.contains("env"),true);
            Assert.assertEquals(getbriefResult.contains("version"),true);
            Assert.assertEquals(getbriefResult.contains("key"),true);
            Assert.assertEquals(getbriefResult.contains("updatedAt"),true);
        }
    }

    /**
     *请求参数uid与token传递,获取通用配置其他信息
     * @throws Exception
     */
    @Test
    public void getbriefTestByUidAndToken() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            ...
            getBriefBO.setUid(hs.get("uid"));
            getBriefBO.setToken(hs.get("token"));
            getBriefBO.setBmAppid("4.00090");
            //参数appid=manual_config.appid，用于查询不同小程序的配置信息
            getBriefBO.setAppid("4.00090");
            //参数Env=manual_config.conf_env
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("请求参数uid与token传递,获取通用配置其他信息");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
    ...
    /**
     * 请求参数AccessToken与bmappid传递,获取通用配置其他信息
     * @throws Exception
     */
    @Test
    public void getbriefTestByAccessToken() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            getBriefUrl = url+"/BusinessService/config/getbrief";
            getBriefBO = new GetBriefBO();
            getBriefBO.setAccessToken("d4c430ebc03debd8a00e15c1fef36110368c314c03cc9a7aa586af7f9e55da87");
            getBriefBO.setBmAppid("4.00090");
            //参数appid=manual_config.appid，用于查询不同小程序的配置信息
            getBriefBO.setAppid("4.00090");
            //参数Env=manual_config.conf_env
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("请求参数AccessToken与bmappid传递,获取通用配置其他信息");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
    ...
    /**
     * 参数keys为空列表，结果提示信息“key is empty”
     * @throws Exception
     */
    @Test
    public void getbriefTestByEmptyKeys() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            ...
            getBriefBO.setEnv("dev");
            //参数Key=manual_config.conf_key
            getBriefBO.setKeys(new ArrayList<>());
            getBriefBO.setVersion("5.0.0");
            log.info("getBriefUrl 请求的参数=" + getBriefUrl);
            log.info("getBriefBO 请求的参数=" + JSON.toJSONString(getBriefBO));
            getbriefResult = HttpUtil.postGeneralUrl(getBriefUrl, "application/json", JSON.toJSONString(getBriefBO), "UTF-8");
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("参数keys为空列表，结果提示信息“key is empty");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
            Assert.assertEquals(getbriefResult.contains("key is empty"),true);
        }
    }
     ...
     */
    @Test
    public void getbriefTestByTwoKeys() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            ...
            //参数Key=manual_config.conf_key
            list.add("articleRecommendation");
            list.add("healthPlanAbs");
            getBriefBO.setKeys(list);
            getBriefBO.setVersion("5.0.0");
            log.info("getBriefUrl 请求的参数=" + getBriefUrl);
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("参数keys为2个元素，返回配置信息");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
            Assert.assertEquals(getbriefResult.contains("healthPlanAbs"),true);
            Assert.assertEquals(getbriefResult.contains("articleRecommendation"),true);
            Assert.assertEquals(getbriefResult.contains("configs"),true);
            Assert.assertEquals(getbriefResult.contains("\"result\":1"),true);
            Assert.assertEquals(getbriefResult.contains("\"msg\":\"ok\""),true);
        }
    ...
    /**
     * 参数keys的值为不存在，返回的config为null
     * @throws Exception
     */
    @Test
    public void getbriefTestByKeysValueNotExist() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("参数keys的值为不存在，返回的config为null");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
            Assert.assertEquals(getbriefResult.contains("\"msg\":\"ok\""),true);
            Assert.assertEquals(getbriefResult.contains("\"result\":1"),true);
            Assert.assertEquals(getbriefResult.contains("\"configs\":null"),true);
        }
    ...
    /**
     * 参数version不传，返回查询条件为
     * SELECT * from manual_config where appid='4.00090' and conf_key in('healthPlanAbs') and enable=1
     * and conf_env='dev'的记录
     * @throws Exception
     */
    @Test
    public void getbriefTestByNotParameterVersion() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
            ...
            list.add("healthPlanAbs");
            getBriefBO.setKeys(list);
            getBriefBO.setVersion("5.0.1");
            log.info("getBriefUrl 请求的参数=" + getBriefUrl);
            log.info("getBriefBO 请求的参数=" + JSON.toJSONString(getBriefBO));
            getbriefResult = HttpUtil.postGeneralUrl(getBriefUrl, "application/json", JSON.toJSONString(getBriefBO), "UTF-8");
            log.info("getbriefResult 返回结果=" + getbriefResult);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("参数version不传，返回所有记录");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
    ...
    /**
     * 参数appid不传，获取通用配置其他信息
     * @throws Exception
     */
    @Test
    public void getbriefTestByNotParameterAppid() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
...
//        getBriefBO.setAppid("4.00090");
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("参数appid不传，获取通用配置其他信息");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
            Assert.assertEquals(getbriefResult.contains("access_deny"),true);
        }

    }

    /**
     * 参数BmAppid不传，获取通用配置其他信息
     * @throws Exception
     */
    @Test
    public void getbriefTestByNotParameterBmAppid() throws Exception {
        String getBriefUrl =null;
        GetBriefBO getBriefBO =null;
        String getbriefResult ="";
        try{
...
//        getBriefBO.setBmAppid("4.00090");
            ...
            HttpLog recordhttp=new HttpLog();
            recordhttp.setCreateTime(new Date());
            recordhttp.setCaseDescribe("参数BmAppid不传，获取通用配置其他信息");
            recordhttp.setUrl(getBriefUrl);
            recordhttp.setRequest(JSON.toJSONString(getBriefBO));
            recordhttp.setResponse(getbriefResult);
            initLog(recordhttp,new Object(){});
            Assert.assertEquals(getbriefResult.contains("bmAppid is empty"),true);
        }
    }
